...
const Pricing = () => {
  ...
  const handlePayment = async (
    ...
    try {
      ...
      await employerService.upgradePlan(
        selectedPlan?.toLowerCase() as "basic" | "pro",
      );
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 max-w-none mx-auto">
          {plans.map((plan) => (
            <PricingCard
              ...
              currentPlan={
                employer?.subscription?.plan === plan.name.toLowerCase()
              }
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-2 text-blue-700">
                  All new employers receive 3 free job posts upon registration.
                  This offer is automatically applied to your account when you
                  sign up.
                </p>
              </div>
            </div>
