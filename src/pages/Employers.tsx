...
const Employers = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Create detailed job listings with our easy-to-use interface",
      icon: Package,
    },
    {
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Post your jobs to millions of qualified candidates and get started
              with 3 free job posts
            </motion.p>
            <motion.button
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Your journey to finding great talent starts here
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  With only 3 free job posts, you're missing out on connecting
                  with thousands of qualified candidates. Don't let great talent
                  slip away.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Every day without the right talent costs your business.
                  Competitors are actively hiring while you're limited by free
                  postings.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 mb-4">
                  Upgrade to a paid plan and get unlimited job posts, bulk
                  uploading, and premium features to streamline your hiring
                  process.
                </p>
                <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Access a pool of pre-screened, qualified candidates
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Track your job performance and hiring metrics
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 p-4 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
